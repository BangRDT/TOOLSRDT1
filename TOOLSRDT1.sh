...
echo $i" |"$cy"     WELCOM TO DARK TERMUX"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" BANG RDT TOOLS  [BANGRDT]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" R.D'T  "$i"                   |"
echo $i" |"$pu" THANKS FOR WHATING
echo $i" |"$pu"
echo $i" |"$pu" Contack WhatsApp :"$ku" 085835787069"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" zhynagahytam"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"RDT"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/FRI3ND8/EmailVuln
cd EmailVuln
python2 vuln.py
fi
